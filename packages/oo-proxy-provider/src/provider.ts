...
export type OoProxyModelId = string

export type OoProxyProviderSettings = CodexOAuthSettings & {
	name?: string
}
...
export interface OoProxyProvider extends ProviderV3 {
	(modelId: OoProxyModelId): LanguageModelV3
	languageModel(modelId: OoProxyModelId): LanguageModelV3
}

export const createOoProxy = (
	settings: OoProxyProviderSettings = {},
): OoProxyProvider => {
	...
	const createModel = (modelId: OoProxyModelId) =>
		new CodexResponsesLanguageModel(modelId, config)

	const providerFn = (modelId: OoProxyModelId) => createModel(modelId)
...
export const openai = createOoProxy()
